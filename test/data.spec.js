...
describe('data', () => {
  ...
  describe('data.loadData', () => {
    ...
    it('debería dataModified ser del mismo tamaño que la data INJURIES', () => {
      data.loadData();
      assert.equal(INJURIES.length, data.dataModified.size);
    });
    it('debería retornar los incidentes segun el medio seleccionado', () => {
      data.loadData();
  ...
  describe('data.percent', () => {
    ...
    it('debería retornar el prociento  segun el medio de tranporte y el año seleccionado', () => {
  ...
  describe('data.changeYearsToList', () => {
    ...
    it('debería retornar el un arreglo cuando lo paso un strin de años', () => {
